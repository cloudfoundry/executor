...
func (self *TaskBBS) ClaimTask(task models.Task, executorID string) (models.Task, error) {
...
func (self *TaskBBS) StartTask(task models.Task, containerHandle string) (models.Task, error) {
	originalValue := task.ToJSON()
...
func (self *TaskBBS) CompleteTask(task models.Task, failed bool, failureReason string, result string) (models.Task, error) {
	originalValue := task.ToJSON()
