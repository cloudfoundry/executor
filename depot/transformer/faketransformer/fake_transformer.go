...
type FakeTransformer struct {
	StepForStub        func(log_streamer.LogStreamer, *models.Action, garden.Container, string, string, []executor.PortMapping, []executor.ProxyPortMapping, bool, bool, lager.Logger) steps.Step
	...
	stepForArgsForCall []struct {
		...
		arg7  []executor.ProxyPortMapping
		arg8  bool
		arg9  bool
		arg10 lager.Logger
	}
...
func (fake *FakeTransformer) StepFor(arg1 log_streamer.LogStreamer, arg2 *models.Action, arg3 garden.Container, arg4 string, arg5 string, arg6 []executor.PortMapping, arg7 []executor.ProxyPortMapping, arg8 bool, arg9 bool, arg10 lager.Logger) steps.Step {
	var arg6Copy []executor.PortMapping
	if arg6 != nil {
		arg6Copy = make([]executor.PortMapping, len(arg6))
		copy(arg6Copy, arg6)
	}
	var arg7Copy []executor.ProxyPortMapping
	if arg7 != nil {
		arg7Copy = make([]executor.ProxyPortMapping, len(arg7))
		copy(arg7Copy, arg7)
	}
	...
	fake.stepForArgsForCall = append(fake.stepForArgsForCall, struct {
		...
		arg9  bool
		arg10 lager.Logger
	}{arg1, arg2, arg3, arg4, arg5, arg6Copy, arg7Copy, arg8, arg9, arg10})
	fake.recordInvocation("StepFor", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6Copy, arg7Copy, arg8, arg9, arg10})
	fake.stepForMutex.Unlock()
	if fake.StepForStub != nil {
		return fake.StepForStub(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeTransformer) StepForArgsForCall(i int) (log_streamer.LogStreamer, *models.Action, garden.Container, string, string, []executor.PortMapping, []executor.ProxyPortMapping, bool, bool, lager.Logger) {
	fake.stepForMutex.RLock()
	defer fake.stepForMutex.RUnlock()
	return fake.stepForArgsForCall[i].arg1, fake.stepForArgsForCall[i].arg2, fake.stepForArgsForCall[i].arg3, fake.stepForArgsForCall[i].arg4, fake.stepForArgsForCall[i].arg5, fake.stepForArgsForCall[i].arg6, fake.stepForArgsForCall[i].arg7, fake.stepForArgsForCall[i].arg8, fake.stepForArgsForCall[i].arg9, fake.stepForArgsForCall[i].arg10
}
