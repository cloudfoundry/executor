...
func (fake *FakeProxyManager) CreateDir(arg1 lager.Logger, arg2 executor.Container) ([]garden.BindMount, []executor.EnvironmentVariable, error) {
...
func (fake *FakeProxyManager) CreateDirCalls(stub func(lager.Logger, executor.Container) ([]garden.BindMount, []executor.EnvironmentVariable, error)) {
	fake.createDirMutex.Lock()
...
func (fake *FakeProxyManager) ProxyPortsArgsForCall(i int) (lager.Logger, *executor.Container) {
	fake.proxyPortsMutex.RLock()
	defer fake.proxyPortsMutex.RUnlock()
	argsForCall := fake.proxyPortsArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2
}
