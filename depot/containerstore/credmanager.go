...
type CredManager interface {
	CreateCredDir(lager.Logger, executor.Container) (CredentialConfiguration, error)
...
func (c *noopManager) CreateCredDir(logger lager.Logger, container executor.Container) (CredentialConfiguration, error) {
...
type CredentialHandler interface {
	...
	CreateDir(logger lager.Logger, container executor.Container) (CredentialConfiguration, error)
...
func (c *credManager) CreateCredDir(logger lager.Logger, container executor.Container) (CredentialConfiguration, error) {
	var mounts []garden.BindMount
	var tmpfs []garden.Tmpfs
	var envs []executor.EnvironmentVariable

	for _, h := range c.handlers {
		credentialConfiguration, err := h.CreateDir(logger, container)
		if err != nil {
			return CredentialConfiguration{}, err
		}
		envs = append(envs, credentialConfiguration.Env...)
		mounts = append(mounts, credentialConfiguration.BindMounts...)
		tmpfs = append(tmpfs, credentialConfiguration.Tmpfs...)
	}
